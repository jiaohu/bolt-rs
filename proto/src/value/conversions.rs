...
macro_rules! impl_from {
    ($T:ty, $V:ident) => {
        impl ::std::convert::From<$T> for $crate::value::value::Value {
...
macro_rules! impl_try_from_value {
    ($T:ty, $V:ident) => {
        impl ::std::convert::TryFrom<$crate::value::value::Value> for $T {
            type Error = $crate::result_type::ConversionError;

            fn try_from(value: $crate::value::value::Value) -> $crate::result_type::ConversionResult<Self> {
                match value {
                    $crate::value::value::Value::$V(inner) => Ok(inner),
                    _ => Err($crate::result_type::ConversionError::FromValue(value)),
                }
            }
        }
    };
...
macro_rules! impl_try_from_value_for_ints {
    ($($T:ty),+) => {
        $(
            impl TryFrom<$crate::value::value::Value> for $T {
                type Error = $crate::result_type::ConversionError;
                ...
                fn try_from(value: $crate::value::value::Value) -> $crate::result_type::ConversionResult<Self> {
                    ...
                    match value {
                        $crate::value::value::Value::Integer(integer) => Ok(integer.try_into()?),
                        _ => Err($crate::result_type::ConversionError::FromValue(value)),
                    }
                }
            }
